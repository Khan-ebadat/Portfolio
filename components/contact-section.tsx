          ...
          >
            ...
            <div className="space-y-6 mt-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:pathanebadat@gmail.com"
            ...
            <div className="mt-12 pt-12 border-t border-border">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/Khan-ebadat" target="_blank" rel="noopener noreferrer" className="btn btn-circle btn-outline">
                ...
                <a href="https://www.linkedin.com/in/ebadat-khan-1829442b6" target="_blank" rel="noopener noreferrer" className="btn btn-circle btn-outline">
